...
tmux send-keys "rosbag record /usb_cam/image_raw /usb_cam/camera_info /RosAria/pose /RosAria/cmd_vel /Robot_1/pose /Robot_1/ground_pose" # change topic if necessary
