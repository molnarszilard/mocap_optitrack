...
tmux select-pane -t 3 # Starting from distrobox this pane will not work
...
tmux send-keys "ros2 bag record -o oak_opti_cam_imu_c24_${today} /Robot_1/pose /RosAria/cmd_vel /oak/imu/data /oak/rgb/camera_info /oak/rgb/image_raw /oak/left/camera_info /oak/left/image_raw /oak/right/camera_info /oak/right/image_raw /tf /Robot_1/ground_pose /RosAria/pose /RosAria/cmd_vel" # Enter
