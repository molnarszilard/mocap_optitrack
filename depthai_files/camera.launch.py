...
def launch_setup(context, *args, **kwargs):
    ...
    print('###################')
    print('Manually hardcoded parameters (change the camera.launch.py file at /opt/ros/humble/share/depthai_ros_driver/launch/camera.launch.py, at around line 173):')
    print(tf_params)
    print('###################')
